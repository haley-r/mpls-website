...
class EventDetails extends Component {
    ...
    componentDidMount = () => {
        if (this.props.user.id){this.props.dispatch({ type: 'FETCH_DETAILS', payload: {eventId: this.props.match.params.eventId, user: true}})}
        else { this.props.dispatch({ type: 'FETCH_DETAILS', payload: { eventId: this.props.match.params.eventId, user: false } }) }
    }
    backToMain =()=> {
